...
combineShader = love.graphics.newShader[[
...
function skin.DrawProgressBar(object)
  ...
  local ATii = object:GetATii()
		
	-- progress bar body
	love.graphics.setColor(bodycolor)
	love.graphics.rectangle("fill", x, y, width, height)
  if ATii then
    --love.graphics.setColor(functions.HSV((value/max)*(256)*(1/3),255,255))
    love.graphics.setColor(functions.HSV((barwidth/width)*(256)*(1/3),255,255))
